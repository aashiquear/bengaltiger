...
#ifndef ThermalExpansionU2DPoly_H
#define ThermalExpansionU2DPoly_H
...
template <>
InputParameters validParams<ThermalExpansionU2DPoly>();

/**
 * ThermalExpansionU2DPoly is a class for models that
 * compute eigenstrains due to thermal expansion of an alpha Uranium material
   swiping its [010] and [001] material properties.
 */
class ThermalExpansionU2DPoly : public DerivativeMaterialInterface<ComputeEigenstrainBase>
{
public:
  ThermalExpansionU2DPoly(const InputParameters & parameters);
