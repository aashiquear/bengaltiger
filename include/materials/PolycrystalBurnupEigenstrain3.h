...
#ifndef POLYCRYSTALBURNUPEIGENSTRAIN3_H
#define POLYCRYSTALBURNUPEIGENSTRAIN3_H

#include "ComputeEigenstrainBase.h"
#include "RankTwoTensor.h"

class PolycrystalBurnupEigenstrain3;
class EulerAngleProvider;
class GrainTrackerInterface;

template <>
InputParameters validParams<PolycrystalBurnupEigenstrain3>();
...
class PolycrystalBurnupEigenstrain3 : public ComputeEigenstrainBase
{
public:
  PolycrystalBurnupEigenstrain3(const InputParameters & parameters);
...
#endif // POLYCRYSTALBURNUPEIGENSTRAIN3_H
