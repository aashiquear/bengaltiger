...
#ifndef POLYCRYSTALBURNUPEIGENSTRAIN2_H
#define POLYCRYSTALBURNUPEIGENSTRAIN2_H

#include "ComputeEigenstrainBase.h"
#include "RankTwoTensor.h"

class PolycrystalBurnupEigenstrain2;
class EulerAngleProvider;
class GrainTrackerInterface;

template <>
InputParameters validParams<PolycrystalBurnupEigenstrain2>();
...
class PolycrystalBurnupEigenstrain2 : public ComputeEigenstrainBase
{
public:
  PolycrystalBurnupEigenstrain2(const InputParameters & parameters);
...
#endif // POLYCRYSTALBURNUPEIGENSTRAIN2_H
