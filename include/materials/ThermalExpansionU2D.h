...
#ifndef ThermalExpansionU2D_H
#define ThermalExpansionU2D_H
...
template <>
InputParameters validParams<ThermalExpansionU2D>();

/**
 * ThermalExpansionU2D is a class for models that
 * compute eigenstrains due to thermal expansion of an alpha Uranium material
   swiping its [010] and [001] material properties.
 */
class ThermalExpansionU2D : public DerivativeMaterialInterface<ComputeEigenstrainBase>
{
public:
  ThermalExpansionU2D(const InputParameters & parameters);
