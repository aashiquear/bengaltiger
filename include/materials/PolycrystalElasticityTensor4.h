...
#ifndef POLYCRYSTALELASTICITYTENSOR4_H
#define POLYCRYSTALELASTICITYTENSOR4_H

#include "ComputeElasticityTensorBase.h"

class PolycrystalElasticityTensor4;
class EulerAngleProvider;

template <>
InputParameters validParams<PolycrystalElasticityTensor4>();
 ...
 * ComputePolycrystalElasticityTensor4 because that actually links up to the grain
...
class PolycrystalElasticityTensor4 : public ComputeElasticityTensorBase
{
public:
  PolycrystalElasticityTensor4(const InputParameters & parameters);
...
#endif // POLYCRYSTALELASTICITYTENSOR4_H
