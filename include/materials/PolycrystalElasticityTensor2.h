...
#ifndef POLYCRYSTALELASTICITYTENSOR2_H
#define POLYCRYSTALELASTICITYTENSOR2_H

#include "ComputeElasticityTensorBase.h"

class PolycrystalElasticityTensor2;
class EulerAngleProvider;

template <>
InputParameters validParams<PolycrystalElasticityTensor2>();
 ...
 * ComputePolycrystalElasticityTensor2 because that actually links up to the grain
...
class PolycrystalElasticityTensor2 : public ComputeElasticityTensorBase
{
public:
  PolycrystalElasticityTensor2(const InputParameters & parameters);
...
#endif // POLYCRYSTALELASTICITYTENSOR2_H
