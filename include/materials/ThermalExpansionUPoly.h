...
#ifndef ThermalExpansionUPoly_H
#define ThermalExpansionUPoly_H
...
template <>
InputParameters validParams<ThermalExpansionUPoly>();

/**
 * ThermalExpansionUPoly is a class for models that
 * compute eigenstrains due to thermal expansion of an anisotropic material.
 */
class ThermalExpansionUPoly : public DerivativeMaterialInterface<ComputeEigenstrainBase>
{
public:
  ThermalExpansionUPoly(const InputParameters & parameters);
