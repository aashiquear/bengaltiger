...
#ifndef POLYCRYSTALBURNUPEIGENSTRAIN_H
#define POLYCRYSTALBURNUPEIGENSTRAIN_H

#include "ComputeEigenstrainBase.h"
#include "RankTwoTensor.h"

class PolycrystalBurnupEigenstrain;
class EulerAngleProvider;
class GrainTrackerInterface;

template <>
InputParameters validParams<PolycrystalBurnupEigenstrain>();
...
class PolycrystalBurnupEigenstrain : public ComputeEigenstrainBase
{
public:
  PolycrystalBurnupEigenstrain(const InputParameters & parameters);
...
#endif // POLYCRYSTALBURNUPEIGENSTRAIN_H
