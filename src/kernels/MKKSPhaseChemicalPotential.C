...
#include "MKKSPhaseChemicalPotential.h"
#include "MathUtils.h"
...
MKKSPhaseChemicalPotential::validParams()
{
  ...
  //                       "concentration, and make sure it is a true site fraction eg. 0.6666666) ");
  params.addParam<MaterialPropertyName>("ka", 
                                        1.0, 
                                        "Site fraction for the ca variable (specify this if ca is a sublattice "
                                        "concentration, and make sure it is a true site fraction eg. 0.6666666) ");
  params.addParam<MaterialPropertyName>("kb", 
                                        1.0, 
                                        "Site fraction for the ca variable (specify this if ca is a sublattice "
                                        "concentration, and make sure it is a true site fraction eg. 0.6666666) ");
...
{
#ifdef DEBUG
  _console << "MKKSPhaseChemicalPotential(" << name() << ") " << _var.name() << ' ' << _cb_name
           << '\n';
#endif
