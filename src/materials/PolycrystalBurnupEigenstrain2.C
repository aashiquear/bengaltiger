...
#include "PolycrystalBurnupEigenstrain2.h"
#include "EulerAngleProvider.h"
#include "RotationTensor.h"
#include "RankTwoScalarTools.h"

registerMooseObject("bengaltigerApp", PolycrystalBurnupEigenstrain2);

template <>
InputParameters
validParams<PolycrystalBurnupEigenstrain2>()
{
...
PolycrystalBurnupEigenstrain2::PolycrystalBurnupEigenstrain2(const InputParameters & parameters)
...
void
PolycrystalBurnupEigenstrain2::computeQpEigenstrain()
{
  ...
  for (auto op_index = beginIndex(op_to_grains); op_index < op_to_grains.size(); ++op_index)
  {
    ...
    if (grain_id < _euler.getGrainNum())
      ...
      mooseError("PolycrystalBurnupEigenstrain2 has run out of grain rotation data.");
