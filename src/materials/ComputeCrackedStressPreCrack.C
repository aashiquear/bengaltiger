...
#include "ComputeCrackedStressPreCrack.h"

registerMooseObject("bengaltigerApp", ComputeCrackedStressPreCrack);

InputParameters
ComputeCrackedStressPreCrack::validParams()
{
...
ComputeCrackedStressPreCrack::ComputeCrackedStressPreCrack(const InputParameters & parameters)
...
void
ComputeCrackedStressPreCrack::initQpStatefulProperties()
{
  _stress[_qp].zero();
...
void
ComputeCrackedStressPreCrack::computeQpProperties()
{
  const Real c = _c[_qp];
