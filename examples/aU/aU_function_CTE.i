...
[Kernels]
  ...
  [./HeatGen]
    type = HeatSource
    variable = temp
    value = 20  #unit: W/um^2
    # function = '2.4e-3 * 1e6 * t/100'
    function = 't/100'
  [../]
[]
...
[Functions]
  ...
  # [./temp_func]
  #   type = ParsedFunction
  #   vars = 'A B steps cycles'
  #   vals = '2.5 345.5 100 100'
  #   value = 'B + A * sin(t * 1e6 * (steps/cycles) * 2 * pi /180)'
  # [../]
  # [./temp_func_top]
  #   type = ParsedFunction
  #   vars = 'A B steps cycles'
  #   vals = '2.5 375.5 100 100'
  #   value = 'B + A * sin(t * 1e6 * (steps/cycles) * 2 * pi /180)'
  # [../]
[]
